...
filename <- here(
    "outputs",
    glue(list_table$plt_fishing_effort[1], "_fishingEffort_L3.png")
)
...
filename <- here(
    "outputs",
    glue(list_table$plt_monitoring_effort[1], "_monitoringEffort_L3.png")
)
png(filename, res = 300, width = 30, height = 20, unit = "cm")
print(plt_monitoring_effort)
dev.off()
...
filename <- here(
    "outputs",
    glue(list_table$plt_monitoring_coverage[1], "_monitoringCoverage_L3.png")
)
png(filename, res = 300, width = 30, height = 20, unit = "cm")
print(plt_monitoring_coverage)
dev.off()
